...
# from .utils import verify_pdf_signature_and_stamp
# import base64
# import io
...
#                 errors.append("❌ The file is not a PDF.")
#             elif pdf_file.size > MAX_FILE_SIZE_MB * 1024 * 1024:
#                 errors.append("❌ The PDF file is larger than 10 MB.")
#             else:
#                 try:
#                     # Read content into memory
#                     pdf_bytes = pdf_file.read()
#                     signature_ok, stamp_ok = verify_pdf_signature_and_stamp(io.BytesIO(pdf_bytes))

#                     if not (signature_ok or stamp_ok):
#                         errors.append("❌ No signature or stamp detected in the designated remarks area.")
#                     else:
#                         result = "✅ PDF passed all checks."
#                         verified = True
#                         # Save base64 string of the PDF into session
#                         request.session['verified_pdf'] = base64.b64encode(pdf_bytes).decode('utf-8')

#                 except Exception as e:
#                     errors.append(f"❌ Error while processing PDF: {str(e)}")
#         else:
